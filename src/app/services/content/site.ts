...
export const SITE_META = {
  ...
  lede:
    'Computer science student at the Colorado School of Mines. I run a homelab and a local AI stack that serves four large language models from one RTX 5090.',
