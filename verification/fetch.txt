# fetch.txt — provenance for the About copy

Source:  https://github.com/JoshT-C  (public GitHub profile README)
Raw URL: https://raw.githubusercontent.com/JoshT-C/JoshT-C/main/README.md
Fetched: 2026-09-22 (initial fetch 2026-09-21)

Purpose: The About section's copy is derived from this public profile README.
         This file records the source so it is clear the bio, experience, and
         skills are the owner's own public words, not invented.

Note:    The profile's contact badges (LinkedIn, email, previous site) are
         omitted below on purpose. The site's contact output lists the email
         address and GitHub the owner chose to publish (2026-09-22); it has no
         LinkedIn link.

--- verbatim profile README, contact badges omitted ---

# Joshua Tuominen-Collins

## 💻 Computer Science Student | Colorado School of Mines

[CONTACT BADGES OMITTED — see note above]
